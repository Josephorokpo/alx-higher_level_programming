...
This project included honing file I/O skills on Node.js and utilizing the NPM request framework to engage with the Star Wars and JSONplaceholder API's. It introduced me to the realm of JavaScript web scraping by employing the request and fs modules.
